...
async function actionPublish (req, res, note) {
  // res.redirect(config.serverURL + '/s/' + (note.alias || note.shortid))

  // upload to ipfs
  const pinata = new PinataClient({ pinataJWTKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..EyoTtoAK9gHZbMiwZjadaaJZdP27zgvb2RZdiO9YzxA' })

  const stream = await string2fileStream(note.content)
  console.log('=====stream', stream)
  await pinata.pinFileToIPFS(stream, { pinataMetadata: {
    name: 'test.md'
  },
  pinataOptions: { cidVersion: 0 } })
    .then((result) => {
      ...
      res.redirect(`https://cloudflare-ipfs.com/ipfs/${hash}`)
    }).catch((err) => {
      // handle error here
      console.log(err)
    })
  // console.log('~~~ pinata.pinFileToIPFS(): ', resp)
  // const hash = resp.IpfsHash
